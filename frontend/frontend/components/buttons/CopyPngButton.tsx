...
const CopyPngButton: React.FC<CopyPngButtonProps> = ({
  ...
  return (
    <button
      onClick={copyAsPNG}
      className="w-full flex items-center justify-center px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 rounded transition-colors"
    >
      <ClipboardCopyIcon
        width="16"
        height="16"
