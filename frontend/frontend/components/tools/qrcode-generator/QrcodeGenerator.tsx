...
import ToolContainer from "@/components/toolComponents/ToolContainer";
import ToolContentCardWrapper from "@/components/toolComponents/ToolContentCardWrapper";
import ToolHead from "@/components/toolComponents/ToolHead";
...
const QrcodeGenerator: React.FC = () => {
  ...
  return (
    <ToolContainer>
      <ToolHead name="QR Code Generator"
