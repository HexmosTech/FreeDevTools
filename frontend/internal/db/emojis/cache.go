...
// Cache TTLs
var (
	CacheTTLTotalEmojis           = 5 * time.Minute
	CacheTTLCategories             = 5 * time.Minute
	CacheTTLCategoriesWithPreview  = 3 * time.Minute
	CacheTTLEmojisByCategory       = 3 * time.Minute
	CacheTTLEmojiBySlug            = 10 * time.Minute
	CacheTTLEmojiImages            = 10 * time.Minute
	CacheTTLCountQueries           = 5 * time.Minute
)
