              ...
              <CardContent className="space-y-6 pt-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          value={charsPerLine}
                          onChange={(e) =>
                            setCharsPerLine(Number(e.target.value))
                          }
                        />
                      </div>
                      <div>
                        <label className="block font-medium text-slate-700 dark:text-slate-300 mb-2">
                          Calculated Input Tokens
                        </label>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                      ...
                      <div>
                        ...
                        <Select
                          value={paperSize}
                          onValueChange={(v) =>
                            setPaperSize(v as keyof typeof PAPER_SIZES)
                          }
                        >
                ...
                <div className="overflow-x-auto">
                    ...
                    <TableBody>
                      {OPENAI_MODELS.map((model) => (
                        <TableRow key={model.name}>
                          ...
                          <TableCell>
                            {model.output !== null ? model.output : '-'}
                          </TableCell>
                          <TableCell className="font-bold">
                            {calculateCostPerCall(model)}
                          </TableCell>
                          <TableCell className="font-bold">
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400 mt-2">
                    <strong>Disclaimer:</strong> Prices are based on data as of
                    September 21, 2025. Please check official OpenAI
                    documentation for the latest rates.
                  </div>
                </div>
              </CardContent>
            </Card>
