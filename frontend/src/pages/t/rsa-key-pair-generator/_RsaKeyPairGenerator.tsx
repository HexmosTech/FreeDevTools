                ...
                {privateKey && (
                  <div className="p-3 bg-yellow-50 text-center dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      ⚠️ Keep your private key secret. Do not share it with
                      anyone.
                    </p>
                  </div>
                )}
          ...
          <ToolContentCardWrapper>
            ...
            <Card>
              ...
              <CardContent className="text-slate-800 dark:text-slate-400 space-y-4">
                <p>
                  An RSA key pair consists of a public key and a private key.
                  These keys are mathematically linked and are used in
                  asymmetric cryptography. The public key can be shared freely,
                  while the private key must be kept secret.
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    <b>Encryption:</b> Data encrypted with the public key can
                    only be decrypted with the corresponding private key.
                  </li>
                  <li>
                    <b>Digital Signatures:</b> A message signed with a private
                    key can be verified by anyone who has the public key,
            ...
            <Card>
              ...
              <CardContent className="text-slate-800 dark:text-slate-400 space-y-4">
                ...
                <p>
                  The key generation process involves selecting two distinct
                  large random prime numbers and multiplying them to create a
                  public modulus. The keys also have a public exponent and a
                  private exponent, which are related through modular
                  arithmetic. Breaking RSA encryption is computationally
                  difficult, as it requires factoring this large modulus, a task
                  for which there is no known efficient algorithm for classical
                  computers.
                </p>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    <b>SSL/TLS Certificates:</b> Securing web traffic (HTTPS).
                  </li>
                  <li>
                    <b>Email Encryption:</b> Used in protocols like PGP and
                    S/MIME to secure email communications.
                  </li>
                  <li>
                    <b>Digital Signatures:</b> Verifying the authenticity of
                    documents and software.
                  </li>
                  <li>
                    <b>Secure Shell (SSH):</b> Authenticating users to servers
