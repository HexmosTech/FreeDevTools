#!/usr/bin/env python3
"""
Copy Discord evolution images from emoji-db.db to emoji-db-v6.db
...
target_db = '/home/lovestaco/hex/fdt-templ/db/all_dbs/emoji-db-v6.db'
...
def main():
    print('🔄 Copying Discord evolution images from emoji-db.db to emoji-db-v6.db\n')
